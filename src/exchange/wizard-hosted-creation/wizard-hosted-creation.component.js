{
    ...
    class controller {
        ...
        retrievingCheckpoint () {
            return this.ovhUserPref
                .getValue(PREFERENCE_CHECKPOINT)
                .catch(() => null);
        }
        ...
        createPreferencesForCurrentServiceIfNeeded (preferences) {
            const currentServiceHasPreferences = !_(preferences[this.$routerParams.organization]).isEmpty();
        ...
        createPreferencesForCurrentDomain (previousPreferences) {
            ...
            const preferencesWithCurrentService = this.createPreferencesForCurrentServiceIfNeeded(preferencesToUse);
        ...
        restoringCheckpoint () {
            return this.retrievingCheckpoint()
                .then((preferences) => {
                    if (!_(preferences).isObject() || _(preferences[this.$routerParams.organization]).isEmpty()) {
                        return null;
                    }
                    ...
                    return this.wizardHostedCreationDomainConfiguration
                        .retrievingDomain(this.$routerParams.organization, this.$routerParams.productId, this.domainName)
                        .then((domain) => {
                            ...
                            this.domainIsAssociatedToEmailService = preferenceToUse.domainIsAssociatedToEmailService;
        ...
        deletingCheckpoint () {
            return this.retrievingCheckpoint()
                ...
                .then((preferences) => {
                    if (!_(preferences).isObject() || _(preferences).isEmpty() || _(preferences[this.$routerParams.organization]).isEmpty()) {
                        return null;
                    }
    ...
    angular
        ...
        .component("exchangeWizardHostedCreation", {
