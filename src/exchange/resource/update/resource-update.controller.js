angular
    ...
    .controller("ExchangeUpdateResourceController", class ExchangeUpdateResourceController {
        ...
        isValid () {
            const displayNameIsValid = _.isString(this.model.displayName) && !_.isEmpty(this.model.displayName) && this.model.displayName.length <= 256;
            const capacityIsValid = _.isNumber(this.model.capacity) && this.model.capacity >= 0 && this.model.capacity <= 1024;
