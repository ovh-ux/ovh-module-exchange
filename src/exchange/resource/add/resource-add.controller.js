    ...
    .controller("ExchangeAddResourceController", class ExchangeAddResourceController {
        ...
        loadResourceData () {
            return this.services
                .ExchangeResources
                .getResourcesOptions(this.$routerParams.organization, this.$routerParams.productId)
                .then((data) => {
        ...
        isValid () {
            ...
            return emailAddressIsCorrect && resourceTypeIsSelected && resourceTypeIsSelected && displayNameIsCorrect && capacityIsCorrect && emailIsFree;
        }
    });
