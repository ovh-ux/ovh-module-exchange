    ...
    .controller("ExchangeRemoveResourceCtrl", class ExchangeRemoveResourceCtrl {
        ...
        submit () {
            ...
            return this.services
                ...
                .then((success) => {
                    this.services.messaging.writeSuccess(this.services.$translate.instant("exchange_tab_RESOURCES_remove_resource_success"), success);
                })
                .catch((failure) => {
                    this.services.messaging.writeError(this.services.$translate.instant("exchange_tab_RESOURCES_remove_resource_failure"), failure);
                })
                .finally(() => {
