angular
    ...
    .controller("ExchangeRemovePublicFolderPermissionCtrl", class ExchangeRemovePublicFolderPermissionCtrl {
        constructor ($scope, Exchange, ExchangePublicFolders, messaging, navigation, $translate) {
            this.services = { $scope, Exchange, ExchangePublicFolders, messaging, navigation, $translate };
        ...
        submitting () {
            ...
            return this.services
                ...
                .then((success) => {
                    this.services.messaging.writeSuccess(this.services.$translate.instant("exchange_action_SHARED_permissions_delete_success"), success);
                })
                .catch((failure) => {
                    this.services.messaging.writeError(this.services.$translate.instant("exchange_action_SHARED_permissions_delete_error"), failure);
                })
                .finally(() => {
