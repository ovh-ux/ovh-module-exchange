angular
    ...
    .controller("ExchangeAddPublicFolderCtrl", class ExchangeAddPublicFolderCtrl {
        ...
        checkPathIsNotReserved () {
            ...
            if (_.has(this.publicFoldersOptions, "reservedPaths") && _(this.publicFoldersOptions.reservedPaths).includes(this.folderToAdd.path)) {
        ...
        checkQuotaValidity () {
            ...
            const quotaIsWithinLimits = this.folderToAdd.quota >= this.publicFoldersOptions.minQuota.value && this.folderToAdd.quota <= this.publicFoldersOptions.maxQuota.value;
