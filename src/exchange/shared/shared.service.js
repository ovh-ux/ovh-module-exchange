angular
    ...
    .service("ExchangePublicFolders", class ExchangePublicFolders {
        ...
        retrievingPublicFolderOptions (organization, serviceName) {
            return this.services
                .OvhHttp
                .get("/sws/exchange/{organization}/{exchange}/publicFolders/options", {
                    rootPath: "2api",
                    urlParams: {
                        organization,
                        exchange: serviceName
        ...
        addingPublicFolder (organization, serviceName, folderToAdd) {
            ...
            return this.services
                .OvhHttp
                .post("/email/exchange/{organization}/service/{exchange}/publicFolder", {
                    rootPath: "apiv6",
                    urlParams: {
                        organization,
                        exchange: serviceName
        ...
        updatingPublicFolder (organization, serviceName, folder) {
            ...
            return this.services
                .OvhHttp
                .put("/email/exchange/{organization}/service/{exchange}/publicFolder/{path}", {
                    rootPath: "apiv6",
                    urlParams: {
                        organization,
                        exchange: serviceName,
        ...
        removingPublicFolders (organization, serviceName, path) {
            return this.services
                .OvhHttp
                .delete("/email/exchange/{organization}/service/{exchange}/publicFolder/{path}", {
                    rootPath: "apiv6",
                    urlParams: {
                        organization,
                        exchange: serviceName,
        ...
        removingPublicFolderPermission (organization, serviceName, path, permission) {
            return this.services
                .OvhHttp
                .delete("/email/exchange/{organization}/service/{exchange}/publicFolder/{path}/permission/{allowedAccountId}", {
                    rootPath: "apiv6",
                    urlParams: {
                        organization,
                        exchange: serviceName,
        ...
        updatingPublicFolderPermissions (organization, serviceName, path, permissions) {
            return this.services
                .OvhHttp
                .put("/sws/exchange/{organization}/{exchange}/publicFolders/{path}/permissions-update", {
                    rootPath: "2api",
                    urlParams: {
                        organization,
                        exchange: serviceName,
