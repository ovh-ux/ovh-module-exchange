angular
    ...
    .controller("ExchangeUpdateSharedAccountCtrl", class ExchangeUpdateSharedAccountCtrl {
        ...
        emailOnChange () {
            ...
            const matchingEmaiAddress = this.alreadyTakenEmails.find((alreadyTakenEmail) => this.accountBeingUpdated.sharedEmailAddress.toUpperCase() === alreadyTakenEmail.toUpperCase());
        ...
        isAccountValid () {
            return this.sharedAccountForm != null && this.sharedAccountForm.$dirty && !_(this.errors).values().includes(true);
        }
