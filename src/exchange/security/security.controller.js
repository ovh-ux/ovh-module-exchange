angular.module('Module.exchange.services').controller(
  'ExchangeServicesConfigureCtrl',
  class ExchangeServicesConfigureCtrl {
    ...
    retrievingDetails() {
      return this.services.APIExchange.get('/{organizationName}/service/{exchangeService}', {
        ...
        .then((serviceDescription) => {
          ...
          this.service.lockoutThreshold = _.isNumber(this.service.lockoutThreshold)
            ? this.service.lockoutThreshold
            : 0;
          this.service.minPasswordLength = _.isNumber(this.service.minPasswordLength)
            ? this.service.minPasswordLength
            : 0;
          this.service.minPasswordAge = _.isNumber(this.service.minPasswordAge)
            ? this.service.minPasswordAge
            : 0;
          this.service.maxPasswordAge = _.isNumber(this.service.maxPasswordAge)
            ? this.service.maxPasswordAge
            : 0;
          this.service.passwordHistoryCount = _.isNumber(this.service.passwordHistoryCount)
