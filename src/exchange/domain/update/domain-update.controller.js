angular
    ...
    .controller("ExchangeUpdateDomainCtrl", class ExchangeUpdateDomainCtrl {
        constructor ($scope, Exchange, $rootScope, ExchangeDomains, Validator, navigation, messaging, translator, exchangeVersion, accountTypes) {
            ...
            this.originalValue = _.cloneDeep(navigation.currentActionData);
        ...
        checkLoopWarning () {
            ...
            return hostName === this.selectedDomain.mxRelay || `${hostName}.` === this.selectedDomain.mxRelay;
        }
        ...
        isValid () {
            ...
            const valueHasntChanged = this.originalValue.type === this.selectedDomain.type && this.originalValue.mxRelay === this.selectedDomain.mxRelay;
            ...
            if (this.isMxRelayVisible()) {
                return this.selectedDomain.mxRelay && !this.checkLengthWarning() && !this.checkLoopWarning() && this.isValidMxRelay(this.selectedDomain.mxRelay);
            }
