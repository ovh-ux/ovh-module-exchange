    ...
    .controller("ExchangeRemoveDomainCtrl", class ExchangeRemoveDomainCtrl {
        ...
        submit () {
            this.services
                ...
                .then(() => {
                    this.services.messaging.writeSuccess(this.services.$translate.instant("exchange_tab_domain_remove_success"));
                })
                .catch((failure) => {
                    this.services.messaging.writeError(this.services.$translate.instant("exchange_tab_domain_remove_failure"), {
