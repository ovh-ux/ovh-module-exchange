angular
    ...
    .controller("ExchangeDomainSrvAutoconfigCtrl", class ExchangeDomainSrvAutoconfigCtrl {
        constructor ($scope, Exchange, ExchangeDomains, navigation, messaging, $translate, exchangeStates) {
            this.services = {
                $scope,
                Exchange,
                ExchangeDomains,
        ...
        configSRV () {
            this.services
                ...
                .catch((failure) => {
                    this.services.messaging.writeError(this.services.$translate.instant("exchange_tab_domain_diagnostic_add_field_failure"), failure);
                })
                .finally(() => {
