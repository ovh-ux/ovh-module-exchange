angular
    ...
    .service("ExchangeDomains", class ExchangeDomains {
        ...
        updatingDomain (organization, productId, domainName, data) {
            return this.services
                .OvhHttp
                .put("/email/exchange/{organization}/service/{exchange}/domain/{domainName}", {
                    rootPath: "apiv6",
                    urlParams: {
                        organization,
                        exchange: productId,
        ...
        removingDomain (organization, serviceName, name) {
            return this.services
                .OvhHttp
                .delete("/email/exchange/{organization}/service/{exchange}/domain/{domainName}", {
                    rootPath: "apiv6",
                    urlParams: {
                        organization,
                        exchange: serviceName,
        ...
        addingZoneDnsField (organization, serviceName, data) {
            return this.services
                .OvhHttp
                .put("/sws/exchange/{organization}/{exchange}/domains/{domain}/dnsSettings-update", {
                    rootPath: "2api",
                    urlParams: {
                        organization,
                        exchange: serviceName,
        ...
        gettingDNSSettings (organization, serviceName, domain) {
            return this.services
                .OvhHttp
                .get("/sws/exchange/{organization}/{exchange}/domains/{domain}/dnsSettings", {
                    rootPath: "2api",
                    urlParams: {
                        organization,
                        exchange: serviceName,
