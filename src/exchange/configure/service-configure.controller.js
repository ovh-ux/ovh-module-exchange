angular
    ...
    .controller("ExchangeServicesConfigureCtrl", class ExchangeServicesConfigureCtrl {
        ...
        retrievingDetails () {
            return this.services.APIExchange
                .get("/{organizationName}/service/{exchangeService}", {
                    urlParams: {
                ...
                .then((serviceDescription) => {
                    ...
                    this.service.lockoutThreshold = _.isNumber(this.service.lockoutThreshold) ? this.service.lockoutThreshold : 0;
                    this.service.minPasswordLength = _.isNumber(this.service.minPasswordLength) ? this.service.minPasswordLength : 0;
                    this.service.minPasswordAge = _.isNumber(this.service.minPasswordAge) ? this.service.minPasswordAge : 0;
                    this.service.maxPasswordAge = _.isNumber(this.service.maxPasswordAge) ? this.service.maxPasswordAge : 0;
                    this.service.passwordHistoryCount = _.isNumber(this.service.passwordHistoryCount) ? this.service.passwordHistoryCount : 0;
        ...
        submitting () {
            ...
            const dataToSend = {
                ...
                passwordHistoryCount: this.service.maxPasswordAge > 0 ? this.service.passwordHistoryCount || null : null,
        ...
        lockoutThresholdCheck (input) {
            ...
            if (this.serviceForm.lockoutObservationWindow != null && this.serviceForm.lockoutDuration != null) {
        ...
        lockoutObservationWindowCheck (input, comesFromLockoutDurationCheck = false) {
            ...
            if (_.isNumber(intValue)) {
                ...
                if (_.isNumber(this.service.lockoutDuration) && !_.isNaN(this.service.lockoutDuration)) {
        ...
        lockoutDurationCheck (input, comesFromLockoutObservationWindowCheck = false) {
            ...
            const intValue = ExchangeServicesConfigureCtrl.convertToNumber(input);
            if (_.isNumber(intValue)) {
                input.$setValidity("min", intValue >= this.service.lockoutObservationWindow && intValue > 0);
                input.$setValidity("max", intValue <= 90);
            } else {
                input.$setValidity("required", false);
            }
