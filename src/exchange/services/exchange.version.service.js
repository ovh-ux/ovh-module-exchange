angular
    ...
    .service("exchangeVersion", class ExchangeVersion {
        ...
        isVersion (versionNumber) {
            const isMatchingVersion = _(this.services.Exchange.value.serverDiagnostic.commercialVersion).includes(versionNumber);
