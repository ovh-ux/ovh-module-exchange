    ...
    .controller("ExchangeExportToCsvAccountsCtrl", class ExchangeExportToCsvAccountsCtrl {
        ...
        exportAccounts () {
            const exportOpts = {
                ...
                rejectAttrs: ["$$hashKey", "currentUsage",
                    "completeDomain", "mailingFilterList",
                    "canBeConfigured", "initial", "samaccountName",
                    "taskPendingId", "id"
                ],
            ...
            // get data for csv
            this.prepareForCsv(exportOpts, 0, {
                headers: [],
                accounts: []
                ...
                .then((datas) => {
                    if (datas != null && !_.isEmpty(datas) && this.timeoutObject != null) {
                        ...
                        const fileName = `export_${this.exchange.displayName}_${moment().format("YYYY-MM-DD_HH:mm:ss")}.csv`;
        ...
        prepareForCsv (exportOpts, offset, infos, timeoutObject) {
            return this.services
                .Exchange
                .prepareForCsv(this.$routerParams.organization, this.$routerParams.productId, exportOpts, offset, timeoutObject)
                .then((datas) => {
                    if (datas != null) {
