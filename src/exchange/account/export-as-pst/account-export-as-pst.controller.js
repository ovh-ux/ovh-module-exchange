angular
    ...
    .controller("ExchangeExportAsPstCtrl", class ExchangeExportAsPstCtrl {
            ...
            return this.services
                ...
                .then((tasksId) => {
                    if (!_.isEmpty(tasksId)) {
                        ...
                        if (firstTask != null && _.isString(firstTask.status) && firstTask.status.toUpperCase() !== "DONE" && _.isString(firstTask.function) && firstTask.function.toUpperCase() !== "DELETEEXPORTPSTREQUEST") {
                            this.exportStep = 7;
        ...
        getExportDetails (firstCall) {
            this.services
                .APIExchange
                .get("/{organizationName}/service/{exchangeService}/account/{account}/export", {
                    urlParams: {
                ...
                .then((result) => {
                    if (result.percentComplete !== 100) {
                        this.exportStep = 3;
                        this.progress = this.services.$translate.instant("exchange_ACTION_display_pst_progress", { percentage: result.percentComplete });
        ...
        postExportDetails () {
            this.services
                .APIExchange
                .post("/{organizationName}/service/{exchangeService}/account/{account}/export", {
                    urlParams: {
                        organizationName: this.exchange.organization,
                        exchangeService: this.exchange.domain,
                        account: this.selectedAccount.primaryEmailAddress
                ...
                .then(() => {
                    this.progress = this.services.$translate.instant("exchange_ACTION_display_pst_progress", { percentage: 0 });
                    this.exportStep = 3;
                    this.getExportDetails();
                })
                .catch((failure) => {
        ...
        getExportUrl (exchange) {
            this.services
                .APIExchange
                .get("/{organizationName}/service/{exchangeService}/account/{account}/exportURL", {
                    urlParams: {
        ...
        postExportUrl (exchange) {
            this.services
                .APIExchange
                .post("/{organizationName}/service/{exchangeService}/account/{account}/exportURL", {
                    urlParams: {
                        organizationName: exchange.organization,
                        exchangeService: exchange.domain,
                        account: this.selectedAccount.primaryEmailAddress
        ...
        deleteExportDetails (exchange) {
            this.services
                .APIExchange
                .delete("/{organizationName}/service/{exchangeService}/account/{account}/export", {
                    urlParams: {
                        organizationName: exchange.organization,
                        exchangeService: exchange.domain,
                        account: this.selectedAccount.primaryEmailAddress
        ...
        checkExportUrlTask (exchange, taskId) {
            return this.services
                .APIExchange
                .get("/{organizationName}/service/{exchangeService}/account/{account}/tasks/{taskId}", {
                    urlParams: {
                        organizationName: exchange.organization,
                        exchangeService: exchange.domain,
                        account: this.selectedAccount.primaryEmailAddress,
                ...
                .then((result) => {
                    if (result.status.toLowerCase() === "done") {
                        ...
                        this.timer = this.services.$timeout(() => this.checkExportUrlTask(exchange, taskId), 10000);
                    }
                })
                .catch((failure) => {
                    this.services.messaging.writeError(this.services.$translate.instant("exchange_ACTION_display_pst_error"), failure);
        ...
        getTasks () {
            return this.services
                .APIExchange
                .get("/{organizationName}/service/{exchangeService}/account/{account}/tasks", {
                    urlParams: {
                        organizationName: this.exchange.organization,
                        exchangeService: this.exchange.domain,
                        account: this.selectedAccount.primaryEmailAddress
