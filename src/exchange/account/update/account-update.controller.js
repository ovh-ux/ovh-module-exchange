angular.module('Module.exchange.controllers').controller(
  'ExchangeUpdateAccountCtrl',
  class ExchangeUpdateAccountCtrl {
    constructor(
      $scope,
      ...
      if (!_.isEmpty(selectedAccount.password)) {
        ...
        if (this.newAccountOptions.passwordComplexityEnabled) {
          ...
          if (
            ...
            && _.includes(selectedAccount.password, selectedAccount.login)
          ) {
          ...
          if (
            ...
            && _.includes(selectedAccount.password, selectedAccount.samaccountName)
          ) {
