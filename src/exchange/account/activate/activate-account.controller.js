angular
    ...
    .controller("ExchangeActivateAccountCtrl", class ExchangeActivateAccountCtrl {
        ...
        $onInit () {
            this.$scope.submit = () => this.submitOperation();
        }

        /**
         * Activate Exchange and deal with the result
         */
        submitOperation () {
            return this.exchangeService.activateExchangeOnAccount(this.$stateParams.productId, this.account.primaryEmailAddress)
                .then(() => {
