angular
    ...
    .controller("ExchangeAddOutlookCtrl", class ExchangeAddOutlookCtrl {
        ...
        isStep1Valid () {
            return this.model.licenceVersion != null && this.model.duration != null && this.selectedOption != null && this.selectedOption.contractsValidated;
        }
        ...
        selectVersion (version) {
            ...
            if (this.model.duration != null) {
                ...
                const option = _.find(version.options, (opt) => opt.duration.duration === this.model.duration);
        ...
        selectDuration (option) {
            ...
            this.selectedOption.contractsValidated = _.isEmpty(this.selectedOption.order.contracts);
        }
