angular
    ...
    .service("group", class Group {
        ...
        retrievingOptionsToCreateNewGroup (organization, serviceName) {
            ...
            const options = this.services.OvhHttp.get("/email/exchange/{organization}/service/{exchange}/domain", {
                rootPath: "apiv6",
                urlParams: {
                    organization,
            ...
            return this.services
                ...
                .all({ models, options })
                .then((data) => {
                    const availableDepartRestrictions = data.models["email.exchange.MailingListDepartRestrictionEnum"].enum.map((m) => _.snakeCase(m).toUpperCase());
                    ...
                    const availableJoinRestrictions = data.models["email.exchange.MailingListJoinRestrictionEnum"].enum.map((m) => _.snakeCase(m).toUpperCase());
        ...
        retrievingMembersByGroup (organization, serviceName, groupName) {
            return this.services
                .OvhHttp
                .get("/sws/exchange/{organization}/{exchange}/groups/{groupName}/members", {
                    rootPath: "2api",
                    clearCache: true,
                    urlParams: {
                        organization,
