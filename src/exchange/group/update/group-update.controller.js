angular
    ...
    .controller("ExchangeUpdateGroupCtrl", class ExchangeUpdateGroupCtrl {
        constructor ($scope, Exchange, group, navigation, messaging, $translate) {
            ...
            if (_.has(this.selectedGroup, "mailingListAddress") && this.selectedGroup.mailingListAddress != null) {
                const atSignIndex = this.selectedGroup.mailingListAddress.indexOf("@");

                if (atSignIndex != null) {
                    this.selectedGroup.address = this.selectedGroup.mailingListAddress.substring(0, atSignIndex);
                    this.domain = this.selectedGroup.mailingListAddress.substring(atSignIndex + 1, this.selectedGroup.mailingListAddress.length);
                }
            }
        ...
        prepareModel () {
            this.model = {
                ...
                maxReceiveSize: this.selectedGroup.receiveSizeUnlimited ? null : this.selectedGroup.maxReceiveSize,
                joinRestriction: _.camelCase(this.selectedGroup.joinRestriction),
                departRestriction: _.camelCase(this.selectedGroup.departRestriction)
            };
        }
            ...
            this.services
                ...
                .then((data) => {
                    ...
                    if (_.isEmpty(data.availableDomains)) {
                        ...
                        this.selectedGroup.completeDomain = _.find(this.groupOptions.availableDomains, {
        ...
        groupIsValid () {
            ...
            const receiveSizeIsCorrect = this.selectedGroup.receiveSizeUnlimited || (this.selectedGroup.maxReceiveSize && /^\d+$/.test(this.selectedGroup.maxReceiveSize));
            const sentSizeIsCorrect = this.selectedGroup.sentSizeUnlimited || (this.selectedGroup.maxSendSize && /^\d+$/.test(this.selectedGroup.maxSendSize));

            return hasGroupOptions && hasCompleteDomain && hasAddress && receiveSizeIsCorrect && sentSizeIsCorrect;
        }
    });
