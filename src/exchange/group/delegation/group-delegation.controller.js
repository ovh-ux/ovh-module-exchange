angular
    ...
    .controller("ExchangeMailingListDelegationCtrl", class ExchangeMailingListDelegationCtrl {
        ...
        hasChanged () {
            ...
            return changesList != null ? changesList.sendRights.length > 0 || changesList.sendOnBehalfToRights.length > 0 : false;
        }
        ...
        getDelegationRight (count, offset) {
            ...
            this.services
                .Exchange
                .getMailingListDelegationRights(this.$routerParams.organization, this.$routerParams.productId, this.selectedGroup.mailingListName, count, offset, this.form.search)
                .then((accounts) => {
