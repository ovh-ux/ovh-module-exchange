angular
    ...
    .service("ExchangeExternalContacts", class ExchangeExternalContacts {
        ...
        isAccountValid (account) {
            ...
            const emailIsValid = !_.isEmpty(account.externalEmailAddress) && this.services.Exchange.constructor.isEmailValid(account.externalEmailAddress);
        ...
        removingContact (organization, serviceName, contactId) {
            return this.services
                .OvhHttp
                .delete("/email/exchange/{organization}/service/{exchange}/externalContact/{externalEmailAddress}", {
                    rootPath: "apiv6",
                    urlParams: {
                        organization,
        ...
        modifyingContact (organization, serviceName, contactId, modifiedContact) {
            ...
            return this.services
                .OvhHttp
                .put("/email/exchange/{organization}/service/{exchange}/externalContact/{externalEmailAddress}", {
                    rootPath: "apiv6",
                    urlParams: {
                        organization,
                        exchange: serviceName,
        ...
        addingContact (organization, serviceName, newContact) {
            return this.services
                .OvhHttp
                .post("/email/exchange/{organization}/service/{exchange}/externalContact", {
                    rootPath: "apiv6",
                    urlParams: {
                        organization,
                        exchange: serviceName
        ...
        gettingContacts (organization, serviceName, count, offset, filter) {
            ...
            return this.services
                .OvhHttp
                .get("/sws/exchange/{organization}/{exchange}/externalContacts", {
                    rootPath: "2api",
                    urlParams: {
                        organization,
                        exchange: serviceName
        ...
        gettingContactOptions (organization, serviceName) {
            return this.services
                .OvhHttp
                .get("/email/exchange/{organization}/service/{exchange}/domain", {
                    rootPath: "apiv6",
                    urlParams: {
                        organization,
                        exchange: serviceName
