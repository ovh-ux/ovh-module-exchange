{
    class officeAttachController {
        ...
        retrievingIfBannerShouldBeDisplayed () {
            ...
            return this.officeAttach.retrievingIfPreferencesAllowBannerDisplaying()
                .then((preferencesAllowBannerDisplaying) => preferencesAllowBannerDisplaying ? this.officeAttach.retrievingIfUserAlreadyHasSubscribed(this.$routerParams.productId) : true)
